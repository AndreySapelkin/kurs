...
class GenMaze:
    ...
    # пошаговая генерация лабиринта методом Прима
    def GenPrimeSS(self, maze):
                ...
                if ((xc >= 0) and (yc >= 0) and (xc < w) and (yc < h) and (AtribLocs[xc][yc] == "I")):
                    ...
                    if (counter == 0):
                        ...
                        if (All == False):
                            maze.PrintToConsole()
                            while (True):
                                print("Нажмите <Enter> для перехода к следующему шагу генерации;")
                                print(
                                    "Введите 'q' - если хотите пропустить оставшиеся промежуточные ходы пошаговой генерации")
                                Dlg = input()
                                if (Dlg == ""):
                                    break
                                if (Dlg == "q"):
    ...
    # пошаговая генерация лабиринта методом Краскала
    def GenKruskalSS(self, maze):
        ...
        while (locations > 1):
            ...
            if (self.WaveTracingSolve(maze, tempw.x, tempw.y, tempw.x + tempw.dx, tempw.y + tempw.dy) == False):
                ...
                if (All == False):
                    ...
                    while (True):
                        print("Нажмите <Enter> для перехода к следующему шагу генерации;")
                        print("Введите 'q' - если хотите пропустить оставшиеся промежуточные ходы пошаговой генерации")
                        Dlg = input()
                        if (Dlg == ""):
                            break
                        if (Dlg == "q"):
